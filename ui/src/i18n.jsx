...
const dict = {
  zh: {
    ...
    'clusters.scaleNeedNode': '请至少选择一个节点', 'clusters.scaleStarted': '扩容任务 #{id} 已启动,可在「部署任务」查看日志',
    ...
    'scale.started': '扩容任务 #{id} 已启动', 'scale.viewTasks': '查看部署任务', 'scale.button': '扩容',
  ...
  en: {
    ...
    'clusters.scaleNeedNode': 'Select at least one node', 'clusters.scaleStarted': 'Scale task #{id} started. Check Deploy Tasks for the log.',
    ...
    'scale.started': 'Scale task #{id} started', 'scale.viewTasks': 'View Deploy Tasks', 'scale.button': 'Scale',
