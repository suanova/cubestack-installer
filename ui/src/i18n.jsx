...
const dict = {
  zh: {
    ...
    'nav.hosts': '宿主机管理', 'nav.vms': '虚拟机管理', 'nav.vmTasks': '安装日志', 'nav.clusters': '集群管理', 'nav.scale': '集群扩容',
    'nav.tasks': '集群任务', 'nav.apiDocs': '接口参考', 'nav.users': '用户管理', 'nav.logout': '退出',
    ...
    'hosts.sc.keyGen': '未检测到管理机 SSH 公钥,自动生成 ed25519 密钥 ...',
    'hosts.sc.mcOk': 'MinIO 客户端 mc 已安装并检查通过 ✓',
    // 添加宿主机向导
    ...
    'vms.created': '虚拟机 {name} 创建任务已启动,查看「集群任务」跟踪进度',
    ...
    'clusters.cpNodes': '控制平面(至少 3 个节点)',
    'clusters.workerNodes': '工作节点 (可选)', 'clusters.sshKey': 'SSH 私钥(可选)',
    'clusters.sshKeyHint': '留空则使用平台默认密钥', 'clusters.noVm': '暂无虚拟机,请先在「虚拟机管理」中创建',
    'clusters.allManaged': '所有节点都已被集群管理,请先在「虚拟机管理」创建新的虚拟机',
    'clusters.needCp': '请至少选择 3 个控制平面节点',
    'clusters.cpHint': '已选为控制平面的节点不能再选为工作节点',
    'clusters.groupHosts': '宿主机', 'clusters.groupVms': '虚拟机',
    'clusters.nodeHost': '宿主机', 'clusters.nodeVm': '虚拟机',
    'clusters.scale': '扩容', 'clusters.scaleTitle': '扩容集群 · {name}',
    'clusters.scaleRole': '新节点角色', 'clusters.scaleRoleWorker': '工作节点 (worker)', 'clusters.scaleRoleMaster': '控制平面 (master)',
    'clusters.scaleHint': '选择要加入集群的节点(未被其他集群纳管);扩容会保留所有已有节点并重新生成 hosts.yml',
    'clusters.scaleNeedNode': '请至少选择一个节点', 'clusters.scaleStarted': '扩容任务 #{id} 已启动,可在「集群任务」查看日志',
    'scale.title': '集群扩容', 'scale.desc': '为已有集群添加控制平面或工作节点(基于 Kubespray scale.yml,不会影响已有节点)',
    'scale.cluster': '选择要扩容的集群', 'scale.noReadyCluster': '暂无已就绪的集群,无法扩容',
    'scale.cpNodes': '新增控制平面节点 (master)', 'scale.workerNodes': '新增工作节点 (worker)',
    'scale.mutexHint': '同一节点不能同时作为控制平面和工作节点',
    'scale.needCluster': '请先选择要扩容的集群', 'scale.needNode': '请至少选择一个要加入的节点',
    'scale.workerOnlyHint': '当前仅支持扩容工作节点',
    'scale.existCp': '当前控制面节点', 'scale.existWorker': '当前工作节点',
    'scale.started': '扩容任务 #{id} 已启动', 'scale.viewTasks': '查看集群任务', 'scale.button': '扩容',
    'clusters.version': '版本 / 插件', 'clusters.nodes': '节点',
    'clusters.cpCount': '控制平面 {n}', 'clusters.workerCount': '工作节点 {n}', 'clusters.nodeCounts': '节点数',
    ...
    'clusters.deployStarted': '集群安装任务 #{id} 已启动,可到「集群任务」查看日志',
    ...
    // 任务
    'tasks.title': '集群任务', 'tasks.desc': 'K8s 集群安装/扩容的异步任务流,点击任务查看实时日志',
    ...
    'tasks.downloadLog': '下载日志', 'tasks.delete': '删除任务',
    'tasks.deleteConfirm': '确定删除任务 #{id} 吗?此操作不可恢复。', 'tasks.deleted': '任务已删除',
    // 虚拟机安装日志
  ...
  en: {
    ...
    'nav.hosts': 'Host Management', 'nav.vms': 'Virtual Machines', 'nav.vmTasks': 'VM Install Task Log', 'nav.clusters': 'Cluster Management', 'nav.scale': 'Cluster Scale',
    'nav.tasks': 'Cluster Tasks', 'nav.apiDocs': 'API Reference', 'nav.users': 'User Management', 'nav.logout': 'Logout',
    ...
    'hosts.sc.keyGen': 'No SSH public key on this machine — generating an ed25519 key ...',
    'hosts.sc.mcOk': 'MinIO client mc installed and verified ✓',
    // Add Host wizard
    ...
    'vms.created': 'VM {name} creation started. Track it under Cluster Tasks.',
    ...
    'clusters.cpNodes': 'Control Plane (min 3 nodes)',
    ...
    'clusters.allManaged': 'All nodes are already managed by clusters. Create new VMs first.',
    'clusters.needCp': 'Select at least 3 control plane nodes',
    'clusters.cpHint': 'A control plane node cannot also be a worker',
    'clusters.groupHosts': 'Hosts', 'clusters.groupVms': 'VMs',
    'clusters.nodeHost': 'Host', 'clusters.nodeVm': 'VM',
    'clusters.scale': 'Scale', 'clusters.scaleTitle': 'Scale Cluster · {name}',
    'clusters.scaleRole': 'New node role', 'clusters.scaleRoleWorker': 'Worker', 'clusters.scaleRoleMaster': 'Control Plane (master)',
    'clusters.scaleHint': 'Select nodes to add (not managed by other clusters). Existing nodes are kept and hosts.yml is regenerated.',
    'clusters.scaleNeedNode': 'Select at least one node', 'clusters.scaleStarted': 'Scale task #{id} started. Check Cluster Tasks for the log.',
    'scale.title': 'Cluster Scale', 'scale.desc': 'Add control plane or worker nodes to an existing cluster (Kubespray scale.yml, existing nodes are untouched)',
    'scale.cluster': 'Cluster to scale', 'scale.noReadyCluster': 'No ready clusters to scale',
    'scale.cpNodes': 'New control plane nodes (master)', 'scale.workerNodes': 'New worker nodes',
    'scale.mutexHint': 'A node cannot be both control plane and worker',
    'scale.needCluster': 'Select a cluster first', 'scale.needNode': 'Select at least one node',
    'scale.workerOnlyHint': 'Only worker nodes can be added for now',
    'scale.existCp': 'Existing control plane nodes', 'scale.existWorker': 'Existing worker nodes',
    'scale.started': 'Scale task #{id} started', 'scale.viewTasks': 'View Cluster Tasks', 'scale.button': 'Scale',
    'clusters.version': 'Version / Plugin', 'clusters.nodes': 'Nodes',
    'clusters.cpCount': 'CP {n}', 'clusters.workerCount': 'Workers {n}', 'clusters.nodeCounts': 'Nodes',
    ...
    'clusters.deployStarted': 'Install task #{id} started. View logs under Cluster Tasks.',
    ...
    // Tasks
    'tasks.title': 'Cluster Tasks', 'tasks.desc': 'Async tasks for K8s cluster install/scale. Click a task to view live logs',
    ...
    'tasks.downloadLog': 'Download Log', 'tasks.delete': 'Delete Task',
    'tasks.deleteConfirm': 'Delete task #{id}? This cannot be undone.', 'tasks.deleted': 'Task deleted',
    // VM install task log
